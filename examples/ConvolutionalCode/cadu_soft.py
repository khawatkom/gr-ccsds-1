...
# Title: Cadu Soft
# Generated: Mon May 13 16:46:05 2019
##################################################
...
class cadu_soft(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.decoder = decoder = fec.cc_decoder.make((8068 - 52), 7, 2, ([79,109]), 29, 6, fec.CC_TAILBITING, False)
        ...
        self.fec_async_decoder_0 = fec.async_decoder(decoder, False, False, 8016)
        ...
        self.ccsds_synchronizeCADUSoft_0 = ccsds.synchronizeCADUSoft('1ACFFC1D',1,7,0,52 + 8016,1,0,'sync')
        self.ccsds_recoverCADUSoft_0 = ccsds.recoverCADUSoft(8068 - 52 , 0, 'sync')
        ...
        self.blocks_tag_debug_0 = blocks.tag_debug(gr.sizeof_float*1, '', "sync"); self.blocks_tag_debug_0.set_display(False)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.ccsds_recoverCADUSoft_0, 'cadu'), (self.fec_async_decoder_0, 'in'))
        self.msg_connect((self.fec_async_decoder_0, 'out'), (self.blocks_pdu_to_tagged_stream_0, 'pdus'))
        self.msg_connect((self.fec_async_decoder_0, 'out'), (self.tdd_nullMsgSink_0, 'in'))
        ...
        self.connect((self.blocks_unpack_k_bits_bb_0, 0), (self.ccsds_convEncoder_0, 0))
