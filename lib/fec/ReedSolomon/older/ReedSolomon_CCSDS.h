 ...
 * -------------------------------------------
 * This file stores Reed Solomon arrays as specified by the CCSDS TM SYNCHRONIZATION 
 * AND CHANNEL CODING blue book standard (August 2011).
 * The matrix calculations are based on codec implemented by Phil Karn
...
#ifndef REEDSOLOMON_CCSDS_H
#define REEDSOLOMON_CCSDS_H

typedef unsigned char data_t;
//Alpha_to for  RS(223,255)
static const data_t E16_alphato[] = {
...
//Indecies for RS(223,255)
static const data_t E16_indexof[] = {
...
//Generator polynomial for RS(223,255)
static const data_t E16_genpoly[] = {
  0,249, 59, 66,  4, 43,126,251, 97, 30,  3,213, 50, 66,170,  5,
  24,  5,170, 66, 50,213,  3, 30, 97,251,126, 43,  4, 66, 59,249,
  0};

//Conventional to dual basis
static const data_t Taltab[] = {
...
//Dual basis to conventional
static const data_t Tal1tab[] = {
